...
\begin{itemize}
    ...
    \item Defined metrics: energy, patience, attention, pacing
\end{itemize}
...
\begin{itemize}
    ...
    \item RAG framework for curriculum alignment \cite{grootendorst2022}
...
\begin{enumerate}
    ...
    \item \textbf{Curriculum Fidelity:} RAG based topic extraction
