...
\\
\\
\indent Outside of the traditional CMS components, key objectives include: 
\begin{itemize}
...
\begin{figure}[htbp]
    ...
    \label{fig:instructor_classes_wireframe}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \label{fig:instructor_profile_wireframe}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Instructor And Admin Norifications wireframe.}
...
\begin{figure}[htbp]
    ...
    \label{fig:admin_finances_wireframe}
\end{figure}
...
\newpage \section{Functional Requirements}
