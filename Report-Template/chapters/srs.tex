...
\begin{itemize}
    ...
    \item Parent profile includes: name, email, contact number, country, billing information.
...
\begin{itemize}
    ...
    \item Instructors recommend next course/module based on performance.
\end{itemize}
...
\textbf{Acceptance Criteria:}
\begin{itemize}
    \item No overlapping instructor class times.
...
\begin{itemize}
    ...
    \item Alerts admin for small class sizes (fewer than 3 students).
\end{itemize}
...
\textbf{Acceptance Criteria:}
\begin{itemize}
    \item Meetings created for 100\% of scheduled classes.
...
\begin{itemize}
    ...
    \item Module progression enforced unless overridden.
...
\begin{itemize}
    ...
    \item Kahoot integration for quizzes.
...
\begin{itemize}
    ...
    \item Evaluation completed within 48 hours.
\end{itemize}
