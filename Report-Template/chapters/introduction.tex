...
integrate with the Zoom and Gmail API to automatically generate and distribute meeting links for scheduled classes. Furthermore, the platform will use performance analysis algorithms to assess instructors based on metrics such as engagement, teaching style, and adherence to the curriculum.
\\
\\
...
The \textit{TeachWise}  project spans two semesters (Kaavish I and II), with a clear division of tasks, milestones, and deliverables to ensure systematic progress. Kaavish I focuses on research, design, and implementation of the core modules, while Kaavish II centers on integration, testing, and deployment.
