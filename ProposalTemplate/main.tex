...
\bibitem{james2023}
A.~James, ``Exploring teacher discourse with NLP: Pedagogical patterns, styles, and student impact,'' \emph{ResearchGate}, 2023. [Online]. Available: \url{https://www.researchgate.net/publication/393413182_Exploring_Teacher_Discourse_with_NLP_Pedagogical_Patterns_Styles_and_Student_Impact}. [Accessed: Sep. 28, 2025].


\bibitem{Automated Large-scale Class Scheduling in MiniZinc}
M. Mushfiqur Rahman, S. Binte Noor and F. Hasan Siddiqui, "Automated Large-scale Class Scheduling in MiniZinc," 2020 2nd International Conference on Sustainable Technologies for Industry 4.0 (STI), Dhaka, Bangladesh, 2020, pp. 1-6, doi: 10.1109/STI50764.2020.9350485. keywords: {Industries;Schedules;Job shop scheduling;Processor scheduling;Manuals;Timing;Task analysis;Class Scheduling;Timetabling;Artificial Intelligence;MiniZinc;Chuffed Solver},
