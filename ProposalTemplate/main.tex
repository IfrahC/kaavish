...
Collectively, these contributions demonstrate the application of theoretical knowledge to solve real-world problems, bridging advanced algorithms, deep learning, and scalable software engineering practices.
...
\begin{itemize}
    ...
    \item Implementation of a scheduling technique that assigns classes automatically while preventing conflicts.
...
\textbf{Deliverables:}
\begin{itemize}
    \item Functional web-based platform with separate dashboards for instructors, students, and administrators.
...
\begin{itemize}
    ...
    \item \textbf{Ifrah Chishti (ic08351):} Contributes to both frontend and backend development, with additional expertise in databases and machine learning. Experienced in Node.js, Python, PostgreSQL, and data science. She is primarily responsible for implementing design and code logic aligned with CodeSchool’s requirements, while also providing backend support alongside Naaseh and Aina.
